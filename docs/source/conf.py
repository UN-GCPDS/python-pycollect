...
htmlhelp_basename = 'PyCollectdoc'
...
latex_documents = [
    (master_doc, 'PyCollect.tex', 'PyCollect Documentation',
...
man_pages = [
    (master_doc, 'pycollect', 'PyCollect Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyCollect', 'PyCollect Documentation',
     author, 'PyCollect', 'One line description of project.',
     'Miscellaneous'),
]
